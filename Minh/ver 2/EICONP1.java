...
public class EICONP1 {
    ...
    static int dfs ( Vertex v , int nVertices ) {
        v.visited = true ; 
        if ( smallestV > v.id ) {
            smallestV = v.id ; // Cập nhật đỉnh nhỏ nhất 
        }
        nVertices++;  // Tăng số lượng đỉnh đã thăm trong thành phần liên thông
        ...
        return nVertices ; // Trả về số lượng đỉnh trong thành phần liên thông
