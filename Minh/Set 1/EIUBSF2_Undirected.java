...
public class EIUBSF2_Undirected {
    ...
    static void bfs (Vertex v ) {
        ...
        while ( !q.isEmpty() ) {
            Vertex vertex = q.poll() ;  // lấy và loại bỏ đỉnh đầu tiên trong hàng đợi 
    ...
    static class Vertex  {
        ...
        public void addAdjecentVertex(Vertex vertex) { // thêm đỉnh kề vào danh sách kề
            adjecentVertices.add(vertex);     
        }

        public int getDegree() { // trả về bậc của đỉnh 
