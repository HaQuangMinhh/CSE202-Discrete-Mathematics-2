...
public class EIUSUFBF_FriendSuggest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for ( Vertex student : students ) {
            List<Vertex> suggestions = student.getFriendSuggestions(K);
    ...
    static class Vertex {
        ...
        List<Vertex> getFriendSuggestions (int minFriends) {
            ...
            for ( Vertex friend : adjecentVertices ) {
                if ( friend.adjecentVertices.size() < minFriends ) {
