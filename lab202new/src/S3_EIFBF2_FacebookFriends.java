...
import java.util.*;
 ...
 class S3_EIFBF2_FacebookFriends {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= n; i++) {
            if (!graph[i].visited) {
                ...
                dfs(graph[i], genderCount, component);
                // update
    ...
    static void dfs(Vertex vertex, int[] genderCount, List<Vertex> component) {
        vertex.visited = true;
