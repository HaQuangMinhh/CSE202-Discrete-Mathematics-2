...
public class Question2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for ( int i = 1 ; i < n  ; i++ ) {
            vertices[i].percent = rd.nextDouble();
        }
        ...
        vertices[0].percent = 100 ; 
        vertices[0].budget = m ; 

        bfs(vertices[0]);

        for ( Vertex vertex : vertices ) {
            sb.append( (int) Math.round(vertex.budget)).append("\n");
        }
    ...
    static void bfs ( Vertex vertex ) {
        ...
        while ( ! q.isEmpty() ) {
            Vertex vertex2 = q.poll();

            for ( Vertex vertex3 : vertex2.adjecentVertices ) {

                if ( ! vertex3.visited ) {
                    vertex3.visited = true ; 
                    vertex3.budget = vertex2.budget * vertex3.percent / 100 ; 
